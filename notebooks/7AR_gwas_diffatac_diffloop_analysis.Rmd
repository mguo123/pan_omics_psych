---
title: "7AR_gwas_diffatac_diffloop_analysis"
output: html_notebook
---

1/16/2021

create heatmaps for diffatac diff loop data (some of this stuff is through the command line)
need
-bedtools installed
...
```{r}
setwd('~/Documents/pan_omics_psych/')
```

```{r}
#ATAC
atac_pks =  list.files('~/Documents/pan_omics_psych/data/interim/merged/atac')
print('atac_pks')
atac_pks
diff_atac_pks = list.files('~/Documents/pan_omics_psych/data/processed/fig1/atac/diffatac/')
print('diff_atac_pks')
...
#hichip
hichip_pks = list.files('~/Documents/pan_omics_psych/data/interim/merged/anchors_bed_sort/')
print('hichip_pks')
hichip_pks
hichip_loops = list.files('~/Documents/pan_omics_psych/data/interim/merged/loops/')
print('hichip_loops')
hichip_loops
diff_hichip_pks = list.files('~/Documents/pan_omics_psych/data/processed/fig2_hichip/hichip_diffloop/',pattern='*anchor.bed')
print('diff_hichip_pks')
diff_hichip_pks
diff_hichip_loops = list.files('~/Documents/pan_omics_psych/data/processed/fig2_hichip/hichip_diffloop/',pattern='*loop.bed')
print('diff_hichip_loops')
diff_hichip_loops
...
1. make diff loop intersection with diff atac
2. make exclusion bed file
3. find overlap
